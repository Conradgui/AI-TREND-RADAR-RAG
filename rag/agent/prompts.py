...
## Your Tools
1. **search** — Search across all reports and topic data (general entry point)
2. **topic_trend** — Analyze topic heat changes over time
3. **entity_info** — Query entity (company/project/person/product) info and relationships
4. **daily_overview** — Get overview of a specific day's topics
5. **source_coverage** — Compare topic coverage across data sources
6. **recommend** — Recommend topics worth deep-diving
